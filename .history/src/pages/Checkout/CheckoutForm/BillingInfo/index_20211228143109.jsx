  ...
  return (
    <div className="billing-info-form">
      <form onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <div className="billing-form-item">
          <TextFiled name="phone" label="Phone number" form={form} />
        </div>
        <div className="billing-form-item">
          <TextFiled name="address" label="Address" form={form} />
        </div>
        <div className="billing-form-item">
          <TextFiled name="town" label="Town / City" form={form} />
        </div>
        ...
        <div className="billing-form-item">
          <TextFiled name="postal" label="ZIP / Postal Code" form={form} />
        </div>
        <div className="billing-form-item">
          <FormControlLabel
            value="ship"
