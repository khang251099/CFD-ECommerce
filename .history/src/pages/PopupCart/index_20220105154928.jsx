...
function PopupCart({ close }) {
  ...
  const cartHaha = useSelector((state) => state.cart);
  ...
  const cartTotal = cartHaha.reduce((a, b) => {
  ...
  const deleteCart = async () => {
    ...
    await handleClose();
    toast.success("Remove this product from cart popup");
  };
        ...
        <>
          <div className="popup-middle">
            <div className="popup-left">
              ...
              <div className="popup-left-item">
                <a href="#" onClick={() => deleteCart(item)}>
                  <img src={remove} />
                </a>
